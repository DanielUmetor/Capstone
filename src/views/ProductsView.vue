        ...
        <template #cardBody>
          <div class="card-body">
            ...
            <div class="button-wrapper d-flex justify-content-between">
              ...
              <button class="btn action-btn cart-btn" @click="addToCart(product)">
...
import { useCart } from '@/composables/cartFunctions'; // Import the cart functions
import Spinner from '@/components/Spinner.vue'
import Card from '@/components/Card.vue'

// Initialize Vuex store and cart functions
const store = useStore()
const products = computed(() => store.state.products)
const { addToCart } = useCart() // Destructure addToCart function from useCart
